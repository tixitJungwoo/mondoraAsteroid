...
var _tokenLogin = require("./base-mixins/token-login");

var loginWithToken = _interopRequireWildcard(_tokenLogin);
...
function createClass() {
    ...
    var mixins = [ddp, methods, subscriptions, login, loginWithToken].concat(customMixins);
